...
namespace WCoe.Framework.Security.Captcha
{
    /// <summary>
    /// HTML extensions
    /// </summary>
    public static class HtmlExtensions
    {
        ...
        private static TagBuilder GenerateLoadApiScriptTag(CaptchaSettings captchaSettings, string captchaId, string render, string language)
        {
            ...
            var url = string.Format($"{captchaSettings.ReCaptchaApiUrl}{WCoreSecurityDefaults.RecaptchaScriptPath}", captchaId, render, hl);
