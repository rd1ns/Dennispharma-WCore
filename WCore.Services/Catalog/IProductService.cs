...
namespace WCore.Services.Catalog
{
    ...
    /// Product service
    /// </summary>
    public partial interface IProductService : IRepository<Product>
    {
        #region Products
        ...
        IList<TierPrice> GetTierPrices(Product product, User user, int storeId);
        ...
        /// <param name="quantity">Quantity</param>
        /// <returns>Tier price</returns>
        TierPrice GetPreferredTierPrice(Product product, User user, int storeId, int quantity);
        ...
        /// <param name="to">Item creation to; null to load all records</param>
        ...
        void ClearDiscountAppliedToProduct(Discount discount);

        /// <summary>
        /// Get a discount-product mapping records by product identifier
        /// </summary>
        /// <param name="productId">Product identifier</param>
        IList<DiscountAppliedToProduct> GetAllDiscountsAppliedToProduct(int productId);
        ...
        /// <returns>Result</returns>
        DiscountAppliedToProduct GetDiscountAppliedToProduct(int productId, int discountId);

        /// <summary>
        /// Inserts a discount-product mapping record
        /// </summary>
        /// <param name="discountProductMapping">Discount-product mapping</param>
        void InsertDiscountAppliedToProduct(DiscountAppliedToProduct discountProductMapping);

        /// <summary>
        /// Deletes a discount-product mapping record
        /// </summary>
        /// <param name="discountProductMapping">Discount-product mapping</param>
        void DeleteDiscountAppliedToProduct(DiscountAppliedToProduct discountProductMapping);
