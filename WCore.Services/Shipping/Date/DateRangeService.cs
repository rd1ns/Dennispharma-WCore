...
namespace WCore.Services.Shipping.Date
{
    /// <summary>
    ...
    public partial class DateRangeService : IDateRangeService
    {
        ...
        {
            var query = from dd in _deliveryDateRepository.GetAll().AsQueryable()
        ...
        {
            var query = from par in _productAvailabilityRangeRepository.GetAll().AsQueryable()
