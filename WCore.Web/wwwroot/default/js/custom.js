    ...
    POTENZA.contactform = function () {
        $("#contactform").submit(function (event) {
            ...
            for (var i = 0; i < fileInputs.length; i++) {
                var fileInput = fileInputs[i].files;
                var fileInputPath = fileInputs[i];
                if (fileInput.length > 0) {
                    var filePath = fileInput[0];
                    data.append($(fileInputPath).attr("name"), filePath);
                }
            }
            var reptchaVal = $("#g-recaptcha-response").val();
            if (reptchaVal != "") {
                $("#ajaxloader").show();
                $("#contactform").hide();
                $.ajax({
                    ...
                    success: function (response) {
                        $("#formmessage").html("");
                        $("#contactform select").prop('selectedIndex', 0);
                ...
                $("#contactform").hide();
                $("#formmessage").html("Recaptcha Required").show().delay(20000).fadeOut('slow');
