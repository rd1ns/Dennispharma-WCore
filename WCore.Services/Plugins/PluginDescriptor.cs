...
namespace WCore.Services.Plugins
{
    ...
    public partial class PluginDescriptor : PluginDescriptorBaseInfo, IDescriptor, IComparable<PluginDescriptor>
    {
        ...
        public static PluginDescriptor GetPluginDescriptorFromText(string text)
        {
            ...
            //wCoreCommerce 2.00 didn't have 'SupportedVersions' parameter, so let's set it to "2.00"
        ...
        public virtual void Save()
        {
            ...
            var filePath = fileProvider.Combine(fileProvider.GetDirectoryName(OriginalAssemblyFile), WCorePluginDefaults.DescriptionFileName);
        ...
        /// <summary>
        /// Gets or sets the supported versions of wCoreCommerce
        /// </summary>
