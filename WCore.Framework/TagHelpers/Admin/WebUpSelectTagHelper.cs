...
{
    /// <summary>
    /// WCore-select tag helper
    /// </summary>
    [HtmlTargetElement("WCore-select", TagStructure = TagStructure.WithoutEndTag)]
    public class WCoreSelectTagHelper : TagHelper
    {
        ...
        public WCoreSelectTagHelper(IHtmlHelper htmlHelper)
        {
