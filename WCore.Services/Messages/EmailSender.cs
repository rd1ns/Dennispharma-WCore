...
namespace WCore.Services.Messages
{
    ...
    public partial class EmailSender : IEmailSender
    {
        ...
        public EmailSender(IDownloadService downloadService, IWCoreFileProvider fileProvider, ISmtpBuilder smtpBuilder)
        {
        ...
        protected MimePart CreateMimeAttachment(Download download)
        {
            ...
            return CreateMimeAttachment($"{fileName}{download.Extension}", download.DownloadBinary, DateTime.Now, DateTime.Now, DateTime.Now);
        }
            ...
            int attachedDownloadId = 0, IDictionary<string, string> headers = null)
        {
            ...
            {
                var download = _downloadService.GetById(attachedDownloadId);
