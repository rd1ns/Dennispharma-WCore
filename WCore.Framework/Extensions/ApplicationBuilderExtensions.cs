...
using WCore.Framework.Globalization;
...
namespace WCore.Framework.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static void StartEngine(this IApplicationBuilder application)
        {
            ...
            //    versions.Delete(mvi => mvi.Description.StartsWith(string.Format(WCoreMigrationDefaults.UpdateMigrationDescriptionPrefix, WCoreVersion.FULL_VERSION)));
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseWCoreExceptionHandler(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseWCoreResponseCompression(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseWCoreStaticFiles(this IApplicationBuilder application)
        {
            ...
            var fileProvider = EngineContext.Current.Resolve<IWCoreFileProvider>();
            ...
            //if (DataSettingsManager.DatabaseIsInstalled)
            //{
            //    var securitySettings = EngineContext.Current.Resolve<SecuritySettingsModel>();
            ...
            application.UseStaticFiles(new StaticFileOptions
            {
                FileProvider = new PhysicalFileProvider(fileProvider.GetAbsolutePath(WCoreCommonDefaults.DbBackupsPath)),
            ...
            //    application.UseStaticFiles(new StaticFileOptions
            //    {
            //        FileProvider = new RoxyFilemanProvider(fileProvider.GetAbsolutePath(WCoreRoxyFilemanDefaults.DefaultRootDirectory.TrimStart('/').Split('/'))),
            //        RequestPath = new PathString(WCoreRoxyFilemanDefaults.DefaultRootDirectory),
            //        OnPrepareResponse = staticFileResponse
            //    });
            //}
        }
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseWCoreAuthentication(this IApplicationBuilder application)
        {
            //check whether database is installed
            //if (!DataSettingsManager.DatabaseIsInstalled)
            //    return;
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseWCoreRequestLocalization(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseWCoreEndpoints(this IApplicationBuilder application)
        {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseWCoreWebMarkupMin(this IApplicationBuilder application)
        {
            //check whether database is installed
            //if (!DataSettingsManager.DatabaseIsInstalled)
            //    return;
