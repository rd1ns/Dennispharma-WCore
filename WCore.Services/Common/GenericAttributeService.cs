...
{
    public class GenericAttributeService : Repository<GenericAttribute>, IGenericAttributeService
    {
        #region Fields
        ...
        #region Ctor
        public GenericAttributeService(WCoreContext context,
        ...
        public virtual IList<GenericAttribute> GetAttributesForEntity(int entityId, string keyGroup)
        {
            ...
            var key = EngineContext.Current.Resolve<ICacheKeyService>()
                .PrepareKeyForShortTermCache(WCoreCommonDefaults.GenericAttributeCacheKey, entityId, keyGroup);

            var query = from ga in context.Set<GenericAttribute>()
