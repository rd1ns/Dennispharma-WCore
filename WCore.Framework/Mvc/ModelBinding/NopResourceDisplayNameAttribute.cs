...
namespace WCore.Framework.Mvc.ModelBinding
{
    ...
    /// </summary>
    public sealed class WCoreResourceDisplayNameAttribute : DisplayNameAttribute, IModelAttribute
    {
        #region Fields
        ...
        public WCoreResourceDisplayNameAttribute(string resourceKey) : base(resourceKey)
        {
        ...
        /// </summary>
        public string Name => nameof(WCoreResourceDisplayNameAttribute);
