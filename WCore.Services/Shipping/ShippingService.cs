...
namespace WCore.Services.Shipping
{
    ...
    public partial class ShippingService : IShippingService
    {
        ...
        {
            //var key = string.Format(WCoreShippingDefaults.ShippingMethodsAllCacheKey, filterByCountryId ?? 0);
        ...
        public virtual void InsertShippingMethod(ShippingMethod shippingMethod)
        {
            ...
            //_cacheManager.RemoveByPrefix(WCoreShippingDefaults.ShippingMethodsPrefixCacheKey);
        ...
        public virtual void DeleteWarehouse(Warehouse warehouse)
        {
            ...
            ////clear cache
            //_cacheManager.RemoveByPrefix(WCoreShippingDefaults.WarehousesPrefixCacheKey);
        ...
        public virtual Warehouse GetWarehouseById(int warehouseId)
        {
            ...
            //var key = string.Format(WCoreShippingDefaults.WarehousesByIdCacheKey, warehouseId);
            ...
            bool includeCheckoutAttributes = true, bool ignoreFreeShippedItems = false)
        {
            ...
            ////checkout attributes
            //if (request.User == null || !includeCheckoutAttributes)
            //    return totalWeight;
            //var checkoutAttributesXml = _genericAttributeService.GetAttribute<string>(request.User, WCoreUserDefaults.CheckoutAttributes, _storeContext.CurrentStore.Id);
            ...
            Address shippingAddress, int storeId, out bool shippingFromMultipleLocations)
        {
            ...
            //        };
            //        //user
            //        request.User = cart.FirstOrDefault(item => item.User != null)?.User;
            //        //ship to
        ...
        public virtual GetPickupPointsResponse GetPickupPoints(Address address, User user = null,
