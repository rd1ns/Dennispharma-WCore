...
namespace SkiTurkish.Model.Settings
{
    ...
    /// Common settings
    /// </summary>
    public class CommonSettingsModel : BaseSkiTurkishModel, ISettingsModel
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should support previous skiTurkishCommerce versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousSkiTurkishcommerceVersions { get; set; }
