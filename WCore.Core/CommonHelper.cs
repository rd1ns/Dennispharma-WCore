...
namespace WCore.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new WCoreException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new WCoreException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
        ...
        /// </summary>
        public static IWCoreFileProvider DefaultFileProvider { get; set; }
