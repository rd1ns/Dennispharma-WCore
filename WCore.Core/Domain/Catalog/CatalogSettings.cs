...
namespace WCore.Core.Domain.Catalog
{
    ...
    public class CatalogSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets "List of products purchased by other user who purchased the above" option is enable
        /// </summary>
        public bool ProductsAlsoPurchasedEnabled { get; set; }

        /// <summary>
        /// Gets or sets a number of products also purchased by other user to display
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether user can select the page size for 'products by tag'
        /// </summary>
