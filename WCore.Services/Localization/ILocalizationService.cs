...
namespace WCore.Services.Localization
{
    ...
    /// </summary>
    public partial interface ILocalizationService : IRepository<LocaleStringResource>
    {

        IPagedList<LocaleStringResource> GetAllByFilters(int languageId, string searchValue = "", string searchName = "", int skip = 0, int take = 10);
