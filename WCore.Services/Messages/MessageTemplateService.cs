...
namespace WCore.Services.Messages
{
    ...
    public partial class MessageTemplateService : Repository<MessageTemplate>, IMessageTemplateService
    {
        ...
        public MessageTemplateService(WCoreContext context, CatalogSettings catalogSettings,
        ...
        public virtual IList<MessageTemplate> GetMessageTemplatesByName(string messageTemplateName, int? storeId = null)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(WCoreMessageDefaults.MessageTemplatesByNameCacheKey, messageTemplateName, storeId);

            return _staticCacheManager.Get(key, () =>
            {
                //get message templates with the passed name
                var templates = _messageTemplateRepository.GetAll()
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(WCoreMessageDefaults.MessageTemplatesAllCacheKey, storeId);

            var query = _messageTemplateRepository.GetAll().AsQueryable();
