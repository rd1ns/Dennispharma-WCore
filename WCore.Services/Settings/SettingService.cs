...
namespace WCore.Services.Settings
{
    public partial class SettingService : Repository<Setting>, ISettingService
    {
        ...
        public SettingService(WCoreContext context, 
            IStaticCacheManager staticCacheManager): base(context)
        {
        ...
        {
            return _staticCacheManager.Get(WCoreConfigurationDefaults.SettingsAllAsDictionaryCacheKey, () =>
            {
        ...
        {
            return GetById(settingId, cache => default);
        }
        ...
        {
            IQueryable<Setting> recordsFiltered = context.Set<Setting>();
            return recordsFiltered.OrderBy(o => o.Name).ToList();
        }
        ...
        {
            _staticCacheManager.RemoveByPrefix(WCoreEntityCacheDefaults<Setting>.Prefix);
        }
