...
namespace WCore.Services.Messages
{
    ...
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        public virtual IList<int> SendGiftCardNotification(GiftCard giftCard, int languageId)
        {
            ...
            var store = order != null ? _storeService.GetById(order.StoreId) ?? _storeContext.CurrentStore : _storeContext.CurrentStore;
        ...
        public virtual IList<int> SendProductReviewReplyUserNotificationMessage(ProductReview productReview, int languageId)
        {
            ...
            var store = _storeService.GetById(productReview.StoreId) ?? _storeContext.CurrentStore;
            languageId = EnsureLanguageIsActive(languageId, store.Id);
        ...
        public virtual IList<int> SendBackInStockNotification(BackInStockSubscription subscription, int languageId)
        {
            ...
            var store = _storeService.GetById(subscription.StoreId) ?? _storeContext.CurrentStore;
            languageId = EnsureLanguageIsActive(languageId, store.Id);
