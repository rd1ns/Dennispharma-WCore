...
namespace WCore.Services.Seo
{
    ...
    /// </summary>
    public static partial class WCoreSeoDefaults
    {
        /// <summary>
        ...
        /// {2} : language ID
        /// </remarks>
        public static CacheKey UrlRecordCacheKey => new CacheKey("WCore.urlrecord.{0}-{1}-{2}");
        ...
        /// {0} : slug
        /// </remarks>
        public static CacheKey UrlRecordBySlugCacheKey => new CacheKey("WCore.urlrecord.byslug.{0}");
