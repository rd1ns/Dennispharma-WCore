...
namespace WCore.Services.Catalog
{
    ...
    /// </summary>
    public partial interface IReviewTypeService : IRepository<ReviewType>
    {
        #region ReviewType
        ...
        IList<ProductReviewReviewType> GetProductReviewReviewTypesByProductReviewId(int productReviewId);
        ...
        void InsertProductReviewReviewTypes(ProductReviewReviewType productReviewReviewType);
