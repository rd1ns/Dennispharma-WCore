...
using SkiTurkish.Core.Domain;
using SkiTurkish.Core.Infrastructure.Mapper;
using SkiTurkish.Model;
...
namespace SkiTurkish.Model.Mapper
{
    ...
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity) where TModel : BaseSkiTurkishEntityModel
        {
            //if (entity == null)
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model)
            where TEntity : BaseEntity where TModel : BaseSkiTurkishEntityModel
        {
            //if (entity == null)
            //    throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BaseSkiTurkishEntityModel model) where TEntity : BaseEntity
        {
            //if (model == null)
            //    throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToSettingsModel<TModel>(this ISettings settings) where TModel : BaseSkiTurkishModel, ISettingsModel
        {
            if (settings == null)
        ...
        public static TSettings ToSettings<TSettings, TModel>(this TModel model, TSettings settings)
            where TSettings : class, ISettings where TModel : BaseSkiTurkishModel, ISettingsModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
