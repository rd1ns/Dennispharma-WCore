...
namespace WCore.Core.Security
{
    /// <summary>
    /// Represents default values related to data protection
    /// </summary>
    public static partial class WCoreDataProtectionDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string RedisDataProtectionKey => "WCore.DataProtectionKeys";
