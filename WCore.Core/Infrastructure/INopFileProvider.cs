...
namespace WCore.Core.Infrastructure
{
    ...
    /// </summary>
    public interface IWCoreFileProvider : IFileProvider
    {
        /// <summary>
        ...
        /// <summary>
        /// Sets the date and time, in coordinated universal time (), that the specified file was last written to
        /// </summary>
        /// <param name="path">The file for which to set the date and time information</param>
        /// <param name="lastWriteTime">
        /// A System.DateTime containing the value to set for the last write date and time of path.
        /// This value is expressed in  time
        /// </param>
