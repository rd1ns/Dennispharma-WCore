...
{
    /// <summary>
    /// WCore-textarea tag helper
    /// </summary>
    [HtmlTargetElement("WCore-textarea", Attributes = ForAttributeName)]
    public class WCoreTextAreaTagHelper : TextAreaTagHelper
    {
        ...
        public WCoreTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
