...
namespace WCore.Core.Infrastructure
{
    /// <summary>
    /// A class that finds types needed by WCore by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IWCoreFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(IWCoreFileProvider fileProvider = null)
        {
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into WCore.
        /// </returns>
        ...
        /// <summary>Gets or sets whether WCore should iterate assemblies in the app domain when loading WCore types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that WCore assemblies aren't investigated (e.g. by not including something like "^WCore|..." you may break core functionality.</remarks>
