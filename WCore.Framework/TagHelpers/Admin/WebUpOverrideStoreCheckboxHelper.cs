...
{
    /// <summary>
    /// WCore-override-store-checkbox tag helper
    /// </summary>
    [HtmlTargetElement("WCore-override-store-checkbox", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class WCoreOverrideStoreCheckboxHelper : TagHelper
    {
        ...
        public WCoreOverrideStoreCheckboxHelper(IHtmlHelper htmlHelper)
        {
