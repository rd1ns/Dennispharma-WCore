...
namespace WCore.Services.Messages
{
    ...
    public partial class NotificationService : INotificationService
    {
        ...
        protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
        {
            ...
            var messages = tempData.ContainsKey(WCoreMessageDefaults.NotificationListKey)
                ? JsonConvert.DeserializeObject<IList<NotifyData>>(tempData[WCoreMessageDefaults.NotificationListKey].ToString())
                : new List<NotifyData>();
            ...
            tempData[WCoreMessageDefaults.NotificationListKey] = JsonConvert.SerializeObject(messages);
        }
