...
namespace WCore.Services.Catalog
{
    ...
    /// </summary>
    public partial interface ICategoryService : IRepository<Category>
    {
        /// <summary>
        /// Clean up category references for a specified discount
        /// </summary>
        /// <param name="discount">Discount</param>
        void ClearDiscountAppliedToCategory(Discount discount);
        ...
        IList<Category> GetAllByFilters(int storeId = 0, bool showHidden = false);
        ...
        /// </param>
        /// <returns>Categories</returns>
        IPagedList<Category> GetAllByFilters(string categoryName, int storeId = 0,
        ...
        IList<int> GetAppliedCategoryIds(Discount discount, User user);
        ...
        DiscountAppliedToCategory GetDiscountAppliedToCategory(int categoryId, int discountId);

        /// <summary>
        /// Inserts a discount-category mapping record
        /// </summary>
        /// <param name="discountAppliedToCategory">Discount-category mapping</param>
        void InsertDiscountAppliedToCategory(DiscountAppliedToCategory discountAppliedToCategory);

        /// <summary>
        /// Deletes a discount-category mapping record
        /// </summary>
        /// <param name="discountAppliedToCategory">Discount-category mapping</param>
        void DeleteDiscountAppliedToCategory(DiscountAppliedToCategory discountAppliedToCategory);
