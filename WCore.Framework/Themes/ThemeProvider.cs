...
namespace WCore.Framework.Themes
{
    ...
    public partial class ThemeProvider : IThemeProvider
    {
        ...
        public ThemeProvider(IWCoreFileProvider fileProvider)
        {
        ...
        public IList<ThemeDescriptor> GetThemes()
        {
            ...
            var themeDirectoryPath = _fileProvider.MapPath(WCorePluginDefaults.ThemesPath);
            foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath, WCorePluginDefaults.ThemeDescriptionFileName, false))
            {
