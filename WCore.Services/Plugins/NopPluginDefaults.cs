...
namespace WCore.Services.Plugins
{
    ...
    /// </summary>
    public static partial class WCorePluginDefaults
    {
        /// <summary>
        ...
        /// {0} : user identifier
        /// </remarks>
        public static CacheKey AdminNavigationPluginsCacheKey => new CacheKey("WCore.plugins.adminnavigation-{0}", AdminNavigationPluginsPrefixCacheKey);

        /// <summary>
        /// Gets a key to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefixCacheKey => "WCore.plugins.adminnavigation";
    }
}