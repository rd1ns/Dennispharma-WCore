...
using WCore.Web.Areas.Admin.Infrastructure.Cache;
...
namespace WCore.Web.Areas.Admin.Factories
{
    ...
    public partial class BaseAdminModelFactory : IBaseAdminModelFactory
    {
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(WCoreModelCacheDefaults.CategoriesListKey, showHidden);
            var listItems = _staticCacheManager.Get(cacheKey, () =>
            {
                var categories = _categoryService.GetAllByFilters(showHidden: showHidden);
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(WCoreModelCacheDefaults.ManufacturersListKey, showHidden);
            var listItems = _staticCacheManager.Get(cacheKey, () =>
            {
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(WCoreModelCacheDefaults.VendorsListKey, showHidden);
            var listItems = _staticCacheManager.Get(cacheKey, () =>
            {
                var vendors = _vendorService.GetAllByFilters(showHidden: showHidden);
