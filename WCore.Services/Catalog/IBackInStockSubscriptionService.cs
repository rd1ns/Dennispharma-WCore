...
namespace WCore.Services.Catalog
{
    ...
    /// </summary>
    public partial interface IBackInStockSubscriptionService : IRepository<BackInStockSubscription>
    {
        /// <summary>
        ...
        /// <returns>Subscriptions</returns>
        BackInStockSubscription FindSubscription(int userId, int productId, int storeId);
