...
namespace WCore.Services.Catalog
{
    ...
    /// </summary>
    public partial interface IManufacturerService : IRepository<Manufacturer>
    {
        /// <summary>
        /// Clean up manufacturer references for a specified discount
        /// </summary>
        /// <param name="discount">Discount</param>
        void ClearDiscountManufacturer(Discount discount);
        ...
        IList<int> GetAppliedManufacturerIds(Discount discount, User user);
