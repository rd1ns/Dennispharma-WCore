...
namespace WCore.Services.Catalog
{
    ...
    /// </summary>
    public partial interface IProductAttributeService : IRepository<ProductAttribute>
    {
        ...
        void DeleteProductProductAttribute(ProductProductAttribute productProductAttribute);
        ...
        IList<ProductProductAttribute> GetProductProductAttributesByProductId(int productId);
        ...
        ProductProductAttribute GetProductProductAttributeById(int productProductAttributeId);

        /// <summary>
        /// Inserts a product attribute mapping
        /// </summary>
        /// <param name="productProductAttribute">The product attribute mapping</param>
        void InsertProductProductAttribute(ProductProductAttribute productProductAttribute);

        /// <summary>
        /// Updates the product attribute mapping
        /// </summary>
        /// <param name="productProductAttribute">The product attribute mapping</param>
        void UpdateProductProductAttribute(ProductProductAttribute productProductAttribute);
        ...
        IList<ProductAttributeValue> GetProductAttributeValues(int productProductAttributeId);
