...
namespace WCore.Core.Domain.Users
{
    ...
    public static class UserExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this User user)
        {
            ...
            var result = user.SystemName.Equals(WCoreUserDefaults.SearchEngineUserName, StringComparison.InvariantCultureIgnoreCase);
        ...
        public static bool IsBackgroundTaskAccount(this User user)
        {
            ...
            var result = user.SystemName.Equals(WCoreUserDefaults.BackgroundTaskUserName, StringComparison.InvariantCultureIgnoreCase);
