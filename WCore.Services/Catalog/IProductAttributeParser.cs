...
namespace WCore.Services.Catalog
{
    ...
    public partial interface IProductAttributeParser
    {
        ...
        IList<ProductProductAttribute> ParseProductProductAttributes(string attributesXml);
        ...
        IList<ProductAttributeValue> ParseProductAttributeValues(string attributesXml, int productProductAttributeId = 0);
        ...
        /// <returns>Product attribute values</returns>
        IList<string> ParseValues(string attributesXml, int productProductAttributeId);
        ...
        string AddProductAttribute(string attributesXml, ProductProductAttribute productProductAttribute, string value, int? quantity = null);
        ...
        /// <param name="productProductAttribute">Product attribute mapping</param>
        /// <returns>Updated result (XML format)</returns>
        string RemoveProductAttribute(string attributesXml, ProductProductAttribute productProductAttribute);
        ...
        /// <returns>Result</returns>
        bool? IsConditionMet(ProductProductAttribute pam, string selectedAttributesXml);
        ...
        decimal ParseUserEnteredPrice(Product product, IFormCollection form);
