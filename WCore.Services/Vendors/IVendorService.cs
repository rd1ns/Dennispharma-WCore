...
namespace WCore.Services.Vendors
{
    ...
    /// </summary>
    public partial interface IVendorService : IRepository<Vendor>
    {
        /// <summary>
        ...
        /// <returns>Vendors</returns>
        IPagedList<Vendor> GetAllByFilters(string name = "", string email = "", int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false);
