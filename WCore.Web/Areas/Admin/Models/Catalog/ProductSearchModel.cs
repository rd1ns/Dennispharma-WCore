...
namespace WCore.Web.Areas.Admin.Models.Catalog
{
    ...
    public partial class ProductSearchModel : BaseSearchModel
    {
        ...
        [WCoreResourceDisplayName("Admin.Catalog.Products.List.SearchIncludeSubCategories")]
        ...
        [WCoreResourceDisplayName("Admin.Catalog.Products.List.SearchPublished")]
        public int SearchPublishedId { get; set; }

        [WCoreResourceDisplayName("Admin.Catalog.Products.List.GoDirectlyToSku")]
