...
namespace WCore.Web.Areas.Admin.Models.Orders
{
    ...
    /// </summary>
    public partial class ShipmentItemModel : BaseWCoreEntityModel
    {
        #region Ctor
        ...
        [WCoreResourceDisplayName("Admin.Orders.Shipments.Products.ProductName")]
        ...
        [WCoreResourceDisplayName("Admin.Orders.Shipments.Products.ItemWeight")]
        public string ItemWeight { get; set; }

        [WCoreResourceDisplayName("Admin.Orders.Shipments.Products.ItemDimensions")]
        ...
        [WCoreResourceDisplayName("Admin.Orders.Shipments.Products.QtyShipped")]
        ...
        public class WarehouseInfo : BaseWCoreModel
        {
