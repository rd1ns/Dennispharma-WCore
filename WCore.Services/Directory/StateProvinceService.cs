...
namespace WCore.Services.Directory
{
    ...
    /// </summary>
    public partial class StateProvinceService : Repository<StateProvince>, IStateProvinceService
    {
        #region Fields
        ...
        public StateProvinceService(WCoreContext context, ICacheKeyService cacheKeyService,
            IStaticCacheManager staticCacheManager,
            IEventPublisher eventPublisher,
            ILocalizationService localizationService,
            IRepository<StateProvince> stateProvinceRepository) : base(context)
        {
        ...
        public virtual StateProvince GetStateProvinceByAbbreviation(string abbreviation, int? countryId = null)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(WCoreDirectoryDefaults.StateProvincesByAbbreviationCacheKey
                , abbreviation, countryId ?? 0);

            var query = context.StateProvinces.Where(state => state.Abbreviation == abbreviation);
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(WCoreDirectoryDefaults.StateProvincesByCountryCacheKey, countryId, languageId, showHidden);
        ...
        public virtual IList<StateProvince> GetStateProvinces(bool showHidden = false)
        {
            ...
            var stateProvinces = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(WCoreDirectoryDefaults.StateProvincesAllCacheKey, showHidden));
