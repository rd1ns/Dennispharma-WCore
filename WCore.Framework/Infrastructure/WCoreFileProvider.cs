...
namespace WCore.Framework.Infrastructure
{
    ...
    /// </summary>
    public class WCoreFileProvider : PhysicalFileProvider, IWCoreFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a WCoreFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public WCoreFileProvider(IWebHostEnvironment webHostEnvironment)
