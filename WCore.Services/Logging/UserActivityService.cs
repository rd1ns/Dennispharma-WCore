...
namespace WCore.Services.Logging
{
    ...
    public class UserActivityService : IUserActivityService
    {
        ...
        {
            //cache
            return _cacheManager.Get(WCoreLoggingDefaults.ActivityTypeAllCacheKey, () =>
            {
        ...
        public virtual void InsertActivityType(ActivityLogType activityLogType)
        {
            ...
            //_cacheManager.RemoveByPrefix(WCoreLoggingDefaults.ActivityTypePrefixCacheKey);
        }
        ...
        {
            var query = from alt in _activityLogTypeRepository.GetAll().AsQueryable()
                        orderby alt.Name
                        select alt;
        ...
        {
            var query = _activityLogRepository.GetAll().AsQueryable();
