...
using WCore.Core.Html.CodeFormatter;
using WCore.Core.Infrastructure;

namespace WCore.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=https://www.WCoreCommerce.com]my site[/url]
                // becomes: <a href="https://www.WCoreCommerce.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.WCoreCommerce.com[/url]
                // becomes: <a href="https://www.WCoreCommerce.com">https://www.WCoreCommerce.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.WCoreCommerce.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.WCoreCommerce.com/Content/Images/Image.jpg">
