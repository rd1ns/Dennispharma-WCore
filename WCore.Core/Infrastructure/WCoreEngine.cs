...
{
    /// <summary>
    /// Represents WCore engine
    /// </summary>
    public class WCoreEngine : IEngine
    {
        #region Fields
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = _typeFinder.FindClassesOfType<IWCoreStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IWCoreStartup)Activator.CreateInstance(startup))
        ...
        public void ConfigureRequestPipeline(IApplicationBuilder application)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IWCoreStartup>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new WCoreException("Unknown dependency");
                        return service;
                    });
            ...
            throw new WCoreException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
